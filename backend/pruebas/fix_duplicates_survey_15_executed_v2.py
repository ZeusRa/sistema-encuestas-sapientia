...
def fix_duplicates(survey_id=15):
    print(f"\n--- Iniciando corrección de duplicados (V2 - Ignore Order) para Encuesta {survey_id} ---")
    ...
    with engine.begin() as conn:
        ...
        # Agrupar por texto y tipo (IGNORANDO ORDEN) para encontrar duplicados
        duplicates_groups = df_questions.groupby(['texto_pregunta', 'tipo'])
        ...
        print("-" * 30)
        print("RESUMEN DE OPERACIONES (V2):")
